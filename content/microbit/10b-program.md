...
Programming is done through a browser at makecode.microbit.org, with no software to install. The editor supports drag-and-drop blocks and text-based Python in the same interface, and includes a simulator so students can test programs before connecting hardware.
...
<div class="lang-compare">
  <div class="lang-card">
    <div class="lang-hdr">
      <span class="lang-name">MakeCode Blocks</span>
    ...
    <div class="lang-body">
      ...
      <ul class="lang-pros">
        <li>No typing required to get started</li>
        <li>Instant feedback in the browser simulator</li>
        <li>View the equivalent JavaScript any time</li>
        <li>Same editor as MicroPython</li>
      </ul>
    </div>
  </div>
  <div class="lang-card">
    <div class="lang-hdr">
      <span class="lang-name">MicroPython</span>
    ...
    <div class="lang-body">
      ...
      <ul class="lang-pros">
        <li>A widely used language in industry and education</li>
        <li>Access to lower-level hardware control and timing</li>
        <li>Works in MakeCode or the dedicated Python editor</li>
        <li>Same board, no additional cost</li>
      </ul>
    </div>
  </div>
</div>
...
<div class="callout">
  <strong>Downloading to the board:</strong> clicking "Download" produces a .hex file. Drag it onto the MICROBIT USB drive that appears when the board is connected, and the program loads automatically. No drivers needed; works on Windows, Mac, and Chromebook.
</div>
